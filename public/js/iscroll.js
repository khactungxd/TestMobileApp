...
//      doc.getElementById("zoomScale").innerHTML = "Scale: "+that.lastScale.toString()+"--- scale2:"+scale.toString()+"--- this.Scale:"+this.scale.toString()+"--- newX: "+newX.toString()+"--- newY: "+newY.toString();
